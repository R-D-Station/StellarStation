...
{
    /// <summary>Создаёт C#-скрипт с авто-namespace: rootNamespace ближайшего .asmdef + путь папок до файла.</summary>
    public static class NamespacedScriptCreator
    {
        // Ctrl/Cmd + Alt + N; пункт рядом с Create > C# Script.
        ...
        public static string ResolveNamespace(string targetFolder)
        {
            ...
            if (asmdefDir != null)
            {
                // путь от папки asmdef до целевой -> суффикс
