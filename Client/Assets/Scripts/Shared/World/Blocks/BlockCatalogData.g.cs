...
namespace Shared.World.Blocks
{
    internal static class BlockCatalogData
    {
        internal static BlockInfo[] Build() => new BlockInfo[]
        {
            ...
            new BlockInfo(11, "FloorAnchor", BlockCategory.FloorAnchor, (BlockFaceFlags)0, (BlockFaceFlags)0, 0, new BlockBox[][] { new[] { new BlockBox(0, 0, 15, 16, 16, 16) } }, 1, 1, 1, new BlockBox[][] { System.Array.Empty<BlockBox>() }, DoorOpening.Auto, null, 1.0f, true, new AttachSurface[] { AttachSurface.Wall, AttachSurface.Floor, AttachSurface.AnySolid, AttachSurface.Ceiling }),
