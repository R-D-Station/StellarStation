...
{
    /// <summary>Ответ сервера при подключении: NetId игрока, серверный TickRate и параметры блок-мира.</summary>
    public struct LoginResponse : INetMessage
    {
        ...
        public void Deserialize(byte[] data)
        {
            ...
            // NetId(4) + TickRate(1) + ShapesMode(1) + ZoneFadeDistance(4) + ZoneFadeVertical(4) = 14 байт
