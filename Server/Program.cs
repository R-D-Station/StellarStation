...
namespace Server
{
    ...
    class Program
    {
        ...
        /// <summary>Глобальный обработчик необработанных исключений: лог и попытка восстановления.</summary>
        ...
        /// <summary>Обработчик необработанных исключений в Task (TPL).</summary>
        ...
        /// <summary>Пытается перезапустить сервер после сбоя.</summary>
